...
//       // Optimistic update + fallback refresh
...
//   return (
//     <div className="p-5 md:p-6 bg-gray-50 min-h-screen">
//       {/* Header */}
//       <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-5 gap-4">
//         <h1 className="text-2xl font-bold text-gray-800">Members</h1>

//         <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
//           <div className="relative flex items-center gap-2 min-w-[320px]">
//             <select
//               value={searchField}
//               onChange={(e) => {
...
//                 setPage(1);
//               }}
//               className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white text-sm shadow-sm"
//             >
...
//                   setPage(1);
//                 }}
//                 className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-sm text-sm"
//               />
//             </div>
//           </div>
...
//             className="px-5 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition font-medium shadow-sm whitespace-nowrap text-sm sm:text-base"
//           >
//             + Create Member
//           </button>
//         </div>
...
//                 <tr>
//                   <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-12">Sr No</th>
//                   <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-20">Image</th>
//                   <th className="px-5 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider min-w-[200px]">Full Name</th>
//                   <th className="px-5 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider min-w-[220px]">Email</th>
//                   <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-32">Phone</th>
//                   <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-24">State</th>
//                   <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-24">Status</th>
//                   <th className="px-4 py-3 text-right text-xs font-semibold text-gray-700 uppercase tracking-wider w-20">Actions</th>
//                 </tr>
//               </thead>
...
//                       <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600 font-medium">{serialNo}</td>
...
//                         <div className="text-sm font-medium text-gray-900 line-clamp-2">{item.fullName || "—"}</div>
//                       </td>
...
//                       <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600">{item.phoneNumber || "—"}</td>

//                       <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600">{item.state || "—"}</td>
...
//                           {openMenuId === item._id && (
//                             <ul className="absolute right-0 mt-1 w-40 bg-white border border-gray-200 rounded-lg shadow-lg z-50 py-1 text-sm">
//                               <li>
//                                 <button
//                                   onClick={() => {
...
//         {/* Pagination – only shown when there's data & more than 1 page */}
//         {!loading && members.length > 0 && totalPage > 1 && (
//           <div className="px-5 py-3 border-t bg-gray-50 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
...
//               <span className="ml-2 text-gray-500">({members.length} items)</span>
//             </div>
...
//                 disabled={page === 1}
//                 className="px-4 py-1.5 border border-gray-300 rounded-md disabled:opacity-50 hover:bg-gray-100 transition disabled:cursor-not-allowed text-sm"
//               >
//                 Previous
//               </button>
//               <button
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-24">Image</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider min-w-[220px]">Full Name</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider min-w-[240px]">Email</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-40">Phone</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-32">State</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-28">Status</th>
                    <th className="px-6 py-3 text-right text-xs font-semibold text-gray-600 uppercase tracking-wider w-24">Actions</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200 bg-white">
                  {members.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-sm font-medium text-gray-900 max-w-[220px] truncate">
                          {item.fullName || "—"}
                        </td>
