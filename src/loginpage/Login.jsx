...
//       {/* Login Card */}
//   <div
//   className="relative z-10 w-[340px] md:w-[400px] min-h-[480px] md:min-h-[520px] mx-4 md:mx-8 my-6 rounded-2xl shadow-2xl px-7 md:px-10 py-9 md:py-12 transform transition-all duration-500 hover:shadow-blue-200/40"
...
//         className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition"
//         required
//       />
//     </div>
...
//           className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition"
//           required
//         />
...
//     <button
//       type="submit"
//       className="w-full py-2 rounded-xl font-semibold text-white bg-[#061B38] shadow-lg transition-all duration-300 hover:bg-[#00113A] hover:scale-[1.02]"
//     >
//       Log In
//     </button>
//   </form>
